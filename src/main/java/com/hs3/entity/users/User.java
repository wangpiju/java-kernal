...
public class User
    ...
    private BigDecimal totalRebate; //历史总返点
    private BigDecimal retrievableRebate; //可提取返点余额
    private Integer depositRebateCount; //代理返点提现次数
    private BigDecimal depositRebateAmount; //代理返点提现金额
