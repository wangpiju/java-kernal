...
@Repository("activityFirstrechargeDao")
public class ActivityFirstrechargeDao
        extends BaseDao<ActivityFirstrecharge> {
    public void save(ActivityFirstrecharge m) {
    ...
    public int update(ActivityFirstrecharge m) {
