...
public class Pk10SideLhPlayerTest {
    private Pk10SideLhPlayer p = new Pk10SideLhPlayer();
    private List<Integer> nums = new ArrayList();
    private String bet = "[1V10]龙虎,[2V9]虎,-,-,-";
    ...
    public void testGetWin() {
        ...
        Assert.assertEquals(win, new BigDecimal("8"));
    }
}
