...
public class ZhihPayApi
        extends PayApi {
    private static final String INPUT_CHARSET = "UTF-8";
    public static final String ID = "zhih";
    private static final String TITLE = "智汇付-网银支付接口";
    private static final String GATEWAY = "https://pay.zhihpay.com/gateway?input_charset=UTF-8";
    ...
    protected String getRemoteUrl(PayApiParam param) {
        return "https://pay.zhihpay.com/gateway?input_charset=UTF-8";
    }
    ...
    public NoticeResult verify(Map<String, String> maps, ApiParam apiParam) {
        ...
        boolean result = RSA.verify(plainText, signature,
                apiParam.getPublicKey(), "", "MD5withRSA");
        if ((result) &&
