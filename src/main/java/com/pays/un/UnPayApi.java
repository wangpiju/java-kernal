...
public class UnPayApi
        extends PayApi {
    public static final String ID = "un";
    private static final String INPUT_CHARSET = "GB2312";
    private static final String GATEWAY = "http://center.qpay888.com/Bank/";
    private static final String TITLE = "乐天付支付接口";
    ...
    protected String getRemoteUrl(PayApiParam param) {
        return "http://center.qpay888.com/Bank/";
    }
    ...
    protected String createPaySign(Map<String, String> maps, String key) {
        ...
        sb.append("tyid").append("=").append((String) maps.get("tyid")).append("&");
    ...
    protected String getTypeid(PayApiParam param) {
        return param.getIsCredit().booleanValue() ? "102" : "0";
    }
