...
public class DinRsaScanPayApi
        extends PayApi {
    public static final String ID = "dinRsaScan";
    ...
    protected static final String SERVICE_TYPE_ZHB = "zhb_scan";
    private static final String TITLE = "智付RSA扫码支付接口";
    private static final String GATEWAY = "https://api.dinpay.com/gateway/api/scanpay";
